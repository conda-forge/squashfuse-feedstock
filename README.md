...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/squashfuse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/squashfuse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install squashfuse
```
...
It is possible to list all of the versions of `squashfuse` available on your platform:
...
```
pixi search squashfuse --channel conda-forge
```
